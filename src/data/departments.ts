...
export const visualArtsImages: GalleryImage[] = [
  ...
  },
  {
    ...
    caption:     '',
    subCaption:  'Exhibition Gallery — 10',
  },
  {
    id: 11,
    localSrc:    va('11'),
    ...
    caption:     '',
    subCaption:  'Exhibition Gallery — 11',
  },
  {
    id: 12,
    localSrc:    va('12'),
    ...
    caption:     'Visitor-8 Watching',
    subCaption:  'Exhibition Gallery — 12',
  },
];
...
export const businessImages: GalleryImage[] = [
  ...
  },
  {
    ...
    fallbackSrc: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80',
    caption:     '',
    subCaption:  'Exhibition Gallery — 5',
  },
  {
    id: 6,
    localSrc:    biz('06'),
    fallbackSrc: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&q=80',
    caption:     '',
    subCaption:  'Exhibition Gallery — 6',
  },
  {
    id: 7,
    localSrc:    biz('07'),
  ...
  },
  {
    ...
    fallbackSrc: 'https://images.unsplash.com/photo-1552581234-26160f608093?w=800&q=80',
    caption:     '',
    subCaption:  'Exhibition Gallery — 8',
  },
  {
    id: 9,
    localSrc:    biz('09'),
    ...
    caption:     '',
    subCaption:  'Exhibition Gallery — 9',
  },
  {
    id: 10,
    localSrc:    biz('10'),
